...
__device__ void contract_expand_dev_light(CSRGraphTex graph, int LEVEL, Worklist2Light in_wl, Worklist2Light out_wl)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
__device__ void contract_expand_dev(CSRGraphTex graph, int LEVEL, Worklist2 in_wl, Worklist2 out_wl)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
__global__ void __launch_bounds__(TB_SIZE_CX, RESIDENCY) contract_expand(CSRGraphTex graph, int LEVEL, Worklist2 in_wl, Worklist2 out_wl)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
__global__ void __launch_bounds__(TB_SIZE, 8) expand(CSRGraphTex graph, Worklist2 in_wl, Worklist2 out_wl)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
__global__ void __launch_bounds__(TB_SIZE, 8) contract(CSRGraphTex graph, int LEVEL, Worklist2 in_wl, Worklist2 out_wl)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
void gg_main_pipe_1(CSRGraphTex& gg, int& LEVEL, PipeContextT<Worklist2>& pipe, dim3& blocks, dim3& threads)
{
  // FP: "1 -> 2;
  // FP: "1 -> 2;
  // FP: "2 -> 3;
...
__global__ void __launch_bounds__(__tb_gg_main_pipe_1_gpu_gb) gg_main_pipe_1_gpu_gb(CSRGraphTex gg, int LEVEL, PipeContextT<Worklist2> pipe, int* cl_LEVEL, GlobalBarrier gb)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
__global__ void gg_main_pipe_1_gpu(CSRGraphTex gg, int LEVEL, PipeContextT<Worklist2> pipe, dim3 blocks, dim3 threads, int* cl_LEVEL)
{
  unsigned tid = TID_1D;
  unsigned nthreads = TOTAL_THREADS_1D;
...
void gg_main_pipe_1_wrapper(CSRGraphTex& gg, int& LEVEL, PipeContextT<Worklist2>& pipe, dim3& blocks, dim3& threads)
{
